        ...
        $resultado = json_decode(curl_exec($ch));
         ...
         echo "<div id='container'>";
            ...
            echo "<div class='escolhaAPI'>";
                ...
                echo "<span class='tituloAPI'>" . $especie->name . "</span><br><br>";
                if ($especie->name == "Yoda's species"){
                echo "<a href='Yoda.php'><button class='buttonEscolha'> Saiba Mais </button> </a>";
                } else {
                    echo "<a href='".$especie->name. ".php'><button class='buttonEscolha'> Saiba Mais </button> </a>";
                }
            echo "</div>";
            }
        echo "</div>";
